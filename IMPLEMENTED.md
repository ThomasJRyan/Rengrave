...
- The left panel also shows a cached input preview: CXF/TTF strokes from the current engraving text sample, DXF line artwork, or bitmap original/trace-mask thumbnails, with decode/parser errors shown inline and a Refresh action for changed files.
