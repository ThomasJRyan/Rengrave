...
- Deeper cooperative cancellation inside long core algorithms. The UI has a background worker, indeterminate progress, core stage reporting, Cancel, and stale-state handling, but core routines still do not stop mid-loop.
...
5. Add cooperative cancellation checks inside expensive core import, cleanup, and v-carve inner loops.
